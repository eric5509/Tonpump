...
export default function MobileSidebar({ navOpened, setNavOpened }: Props) {
  ...
  return (
    <div className={`bg-mainDark flex flex-col gap-8 justify-between p-3 fixed w-full top-[70px] overflow-hidden lg:hidden z-[5000] duration-300 ${navOpened ? "left-0 h-[calc(100vh-70px)] overflow-y-auto opacity-100 blur-none" : "-left-full blur-2xl h-0 opacity-0"}`}>
      <div className="">
      ...
      <div className="flex items-center justify-between text-prim font-semibold">
        ...
        <div className="flex overflow-hidden">
          <img onClick={() => setNavOpened(false)} src="toggler.png" className="translate-x-9 cursor-pointer duration-300 scale-75 active:scale-50" alt="" />
        </div>
      </div>
      <div
