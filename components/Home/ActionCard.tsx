        ...
        <div className="font-semibold">
            {title === "create" && <div className={`h-14 w-full duration-500   transition-colors ${!darkmode ? "bg-[#EDEFF2]": "bg-[#D8FDFD0F]"} text-white grid grid-cols-[1fr_50px] items-center gap-3 p-3 rounded-xl relative`}>
                <div className="flex items-center gap-2">
                    ...
                    <p className={`text-11 md:text-xs ${darkmode ? "text-white": "text-secondary"}`}><b>{user}</b> created $Space</p>
                </div>
            ...
            {title === "buy" && <div className="h-14 w-full bg-[#29cc3933] text-white grid grid-cols-[1fr_50px] items-center gap-3 p-3 rounded-xl relative">
                <div className="flex items-center gap-2">
                    <img src="updateIcon.png" alt="" />
                    <p className="text-11 md:text-xs text-[#4DB24D]"><b>{user}</b> bought {amount} TON of $Apple</p>
