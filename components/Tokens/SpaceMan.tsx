...
export default function SpaceMan() {
    return (
        <div className="">
            <div className="bg-[#272727] hidden lg:block text-xs rounded-2xl p-3">
                <div className='flex text-white bg-[#323434] border-2 border-[#8996A9] rounded-2xl justify-between items-center gap-5 p-3'>
                    <div className="">
