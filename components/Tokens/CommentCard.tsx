        ...
        <div className="flex gap-3 lg:gap-5">
            ...
            <div className="flex flex-col gap-1 lg:gap-4">
                <div className="flex items-center justify-between lg:justify-start gap-4">
                    ...
                    <p className='hidden text-13 lg:block text-[#838A91]'>20 Mar 2021 at 05:15 PM</p>
                ...
                <div className="">
                    <p className='text-white bg-[#292F32] p-3 text-13 rounded-lg'>This is one of the best project i’ve ever come across. This is the deal guys.</p>
                    <p className='text-[9px] mt-0.5 lg:hidden text-xs text-[#838A91]'>20 Mar 2021 at 05:15 PM</p>
                </div>
